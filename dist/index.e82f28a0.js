...
function encodeImageFileAsURL(element) {
    ...
    reader.onloadend = function() {
        ...
        identifyPlant(reader.result, "Yndjn3ZSOe8kCtlv6EKpLX30qMtM9eTFA0RajI4QctDnDEEhk1");
    };
...
const reqPreview = async function(userQuery) {
    try {
        const data = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL_PLANT_LIST)}?key=${(0, _configJs.API_KEY)}&q=${userQuery}`);
        const data2 = (0, _helpersJs.removePremiumPlants)(data.data);
...
const genMarkupPreview = function(data) {
    const dmap = data.map((result)=>` <li class="preview">
...
const reqPlant = async function(id) {
    try {
        const data = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL_PLANT_DETAILS)}/${id}?key=${(0, _configJs.API_KEY)}`);
        const data_careGuide = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL_PLANT_CARE_GUIDE)}?species_id=${id}&key=${(0, _configJs.API_KEY)}`);
        const plant = data;
        ...
        if (state.bookmarks.some((bmarked)=>bmarked.id === +id)) state.plant.bookmarked = true;
...
const plantClick = function() {
    console.log("IAJHSDIOAJSDIOAJS");
...
[
    "hashchange"
].forEach((ev)=>window.addEventListener(ev, plantClick));

},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./config.js":"k5Hzs","./helpers.js":"hGI1E"}],"49tUX":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "API_URL_PLANT_LIST", ()=>API_URL_PLANT_LIST);
parcelHelpers.export(exports, "API_URL_PLANT_DETAILS", ()=>API_URL_PLANT_DETAILS);
parcelHelpers.export(exports, "API_URL_PLANT_CARE_GUIDE", ()=>API_URL_PLANT_CARE_GUIDE);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
parcelHelpers.export(exports, "API_KEY", ()=>API_KEY);
parcelHelpers.export(exports, "RESULTS_PER_PAGE", ()=>RESULTS_PER_PAGE);
const API_URL_PLANT_LIST = "https://perenual.com/api/species-list";
const API_URL_PLANT_DETAILS = "https://perenual.com/api/species/details";
const API_URL_PLANT_CARE_GUIDE = "https://perenual.com/api/species-care-guide-list";
const TIMEOUT_SEC = 7;
const API_KEY = "sk-XZXO65a5abb0087263793";
...
parcelHelpers.export(exports, "removePremiumPlants", ()=>removePremiumPlants);
...
const removePremiumPlants = function(data) {
    return data.filter((data)=>data?.default_image?.original_url !== undefined && data?.default_image?.original_url !== "https://perenual.com/storage/image/upgrade_access.jpg");
};

},{"./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2L15i","dV6cC"], "dV6cC", "parcelRequiredb8f")
